  ...
  for (auto& m : *this)
      if constexpr (Type == CAPTURES)
          ...
          m.value =      (*mainHistory)[pos.side_to_move()][from_to(m)]
                   + 2 * (*continuationHistory[0])[pos.moved_piece(m)][to_sq(m)] - (*continuationHistory[0])[pos.moved_piece(m)][from_sq(m)]
                   +     (*continuationHistory[1])[pos.moved_piece(m)][to_sq(m)] - (*continuationHistory[1])[pos.moved_piece(m)][from_sq(m)]
                   +     (*continuationHistory[3])[pos.moved_piece(m)][to_sq(m)] - (*continuationHistory[3])[pos.moved_piece(m)][from_sq(m)]
                   +     (*continuationHistory[5])[pos.moved_piece(m)][to_sq(m)] - (*continuationHistory[5])[pos.moved_piece(m)][from_sq(m)]
